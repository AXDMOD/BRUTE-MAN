...
"""+reset)
print("\033[1;37m================= \33[32;45mINSTA FB HACKING TOOL BY BRUTE-MAN\33[0;m =====================")
print(bold+red+"    \n Devoloped By :"+reset, end=' ')
print("\x1b[1;94mBRUTE-MAN", end=' ')
print(bold+red+"          FOLLOW :"+reset, end=' ')
print("\x1b[1;96minmyInstagram")
print(" ")
print("\033[92m                   BRUTEFORCE"+reset)
...
if number == 1:
    async def main():
        ...
        print("\033[32mTool devoloped : BRUTE-MAN\033[0m")
